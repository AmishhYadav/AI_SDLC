...
- [x] 06-01-PLAN.md — Tenancy core: error codes, @NoTenantScope, TenantContextService, TenantedPrismaService ($extends), BaseRepository, unit tests (TENANT-01, TENANT-02, SEAM-05)
